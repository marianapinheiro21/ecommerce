...
class Cliente(models.Model):
    ...
    mail = models.CharField(unique=True, max_length=-1)
    pass_field = models.CharField(db_column='pass', max_length=-1, blank=True, null=True)  # Field renamed because it was a Python reserved word.
    ntelefone = models.DecimalField(max_digits=9, decimal_places=0)
    morada = models.CharField(max_length=-1)
...
class Logista(models.Model):
    ...
    pass_field = models.CharField(db_column='pass', max_length=-1, blank=True, null=True)  # Field renamed because it was a Python reserved word.
    ntelefone = models.DecimalField(max_digits=9, decimal_places=0)
    morada = models.CharField(max_length=-1, blank=True, null=True)
...
class ProjpsiCliente(models.Model):
    nome = models.CharField(max_length=50)
    nif = models.IntegerField(primary_key=True)
    mail = models.CharField(max_length=50)
    passw = models.CharField(max_length=50)
